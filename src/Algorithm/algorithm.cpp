...
{    
    ...
    while (fp::Algorithm::CheckGoal(node_c.x, node_c.y) == false){  // while goal is not reached
        if(fp::Algorithm::CheckNode(pose_c, found_d) == false){     // if this spot haven't been explored by robot under this pose before
